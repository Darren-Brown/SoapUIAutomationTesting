...
namespace HypemediaWebApi2012.WebApi.Infrastructure.Installers
{
    ...
    public class DomainServicesInstaller : IWindsorInstaller
    {
        ...
        void RegisterUsingContainer(IWindsorContainer container)
        {
            ...
            container
                .Register(Classes.FromAssembly(_apiDomainServicesAssembly).BasedOn<IDomainService>().WithServiceFromInterface());
